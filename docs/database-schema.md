...
- `seller_notification_preferences`, linked to seller profiles, storing category-level in-app and email notification opt-in state for Verification, Products, Revisions, and Ads. Missing rows default both channels to enabled behavior.
