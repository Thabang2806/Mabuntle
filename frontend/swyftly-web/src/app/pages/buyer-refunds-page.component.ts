      ...
      @if (isLoading()) {
        ...
        @if (refunds().length === 0 && !errorMessage()) {
          ...
          <section class="buyer-panel">
            ...
            <p>Refund status is updated by finance and provider confirmation. Provider action in progress means Swyftly is still waiting on finance or provider completion.</p>
