...
describe('BuyerVisualSearchPageComponent', () => {
  ...
  beforeEach(async () => {
    localStorage.removeItem('swyftly.buyer.visualSearch.recentReferences');
  ...
  it('stores, reuses, and clears text references without storing uploaded image data', async () => {
    ...
    const stored = JSON.parse(localStorage.getItem('swyftly.buyer.visualSearch.recentReferences') ?? '[]');
    ...
    expect(localStorage.getItem('swyftly.buyer.visualSearch.recentReferences')).toBeNull();
  ...
  it('resets selected search state without clearing local recent references', async () => {
    ...
    expect(localStorage.getItem('swyftly.buyer.visualSearch.recentReferences')).toContain('black formal maxi dress');
  });
