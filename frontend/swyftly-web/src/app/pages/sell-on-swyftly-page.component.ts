...
@Component({
  selector: 'app-sell-on-swyftly-page',
  imports: [
    ...
    <section class="sell-page">
      <section class="sell-hero" aria-labelledby="sell-title">
        <div class="sell-hero-copy">
          <span class="eyebrow">Sell on Swyftly</span>
          <h1 id="sell-title">Build a reviewed fashion, beauty, or jewellery storefront.</h1>
          <p>
            Swyftly gives sellers a guided path from registration to verification, reviewed listings, stock control,
      ...
      <section class="page sell-section">
        <div class="sell-deferred-panel">
          <div>
            ...
            <p>
              Swyftly currently keeps seller workflows provider-neutral where real external integrations are not yet
