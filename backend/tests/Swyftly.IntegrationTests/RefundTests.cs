...
public sealed class RefundTests
{
    ...
    public async Task BuyerCanReadOwnRefunds_ByListDetailOrderAndReturn()
    {
        ...
        var buyerAuth = await RegisterAndLoginAsync(buyerClient, "buyer-refund-reader@example.test", SwyftlyRoles.Buyer);
    ...
    public async Task BuyerRefundReads_AreScopedToAuthenticatedBuyer()
    {
        ...
        var firstBuyerAuth = await RegisterAndLoginAsync(firstBuyerClient, "buyer-refund-owner@example.test", SwyftlyRoles.Buyer);
        await RegisterAndLoginAsync(secondBuyerClient, "buyer-refund-other@example.test", SwyftlyRoles.Buyer);
