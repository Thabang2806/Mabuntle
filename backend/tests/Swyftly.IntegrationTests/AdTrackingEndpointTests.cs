...
public sealed class AdTrackingEndpointTests
{
    ...
    public async Task ImpressionWithoutVisitorId_DedupesByRequestFingerprint()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.ParseAdd("SwyftlyIntegrationTests/1.0");
    ...
    {
        private readonly string _databaseName = $"SwyftlyAdTrackingEndpointTests_{Guid.NewGuid():N}";
