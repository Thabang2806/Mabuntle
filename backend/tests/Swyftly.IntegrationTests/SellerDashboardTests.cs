...
public sealed class SellerDashboardTests
{
    ...
    public async Task Buyer_CannotAccessSellerDashboardSummary()
    {
        ...
        await RegisterAsync(client, "dashboard-buyer@example.test", SwyftlyRoles.Buyer);
    ...
    {
        private readonly string _databaseName = $"SwyftlySellerDashboardTests_{Guid.NewGuid():N}";
