...
namespace Swyftly.Api.Disputes;
...
public static class DisputeEndpoints
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await AddMessageAsync(disputeId, request, principal, buyer.Id, SwyftlyRoles.Buyer, disputeWorkflowService, timeProvider, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await AddMessageAsync(disputeId, request, principal, seller.Id, SwyftlyRoles.Seller, disputeWorkflowService, timeProvider, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await AddEvidenceAsync(disputeId, request, principal, buyer.Id, SwyftlyRoles.Buyer, disputeWorkflowService, timeProvider, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await AddEvidenceAsync(disputeId, request, principal, seller.Id, SwyftlyRoles.Seller, disputeWorkflowService, timeProvider, cancellationToken);
    }
    ...
    private static IQueryable<Dispute> DisputeQuery(SwyftlyDbContext dbContext) =>
        dbContext.Disputes
